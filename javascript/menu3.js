// JS ACTUALIZADO CON SOPORTE PARA SÍMBOLOS ROBOFAN
...
function initSettingsMenu3() {
  ...
  if (fuenteSettings) {
    ...
    if (localStorage.getItem("tph_robofan_symbols_enabled") === "true") {
      const simbolo = localStorage.getItem("tph_robofan_symbol_selected") || "b";
  ...
  dropdown.addEventListener("change", () => {
    ...
    // ✅ Aplicar Robofan si está activado y se aplicó la fuente
    if (
      (aplicarH2 || aplicarH3H4 || aplicarButtons) &&
      localStorage.getItem("tph_robofan_symbols_enabled") === "true"
    ) {
